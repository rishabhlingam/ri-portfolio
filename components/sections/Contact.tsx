...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/rishabhlingam", external: true },
  { label: "LinkedIn", href: "https://linkedin.com/in/rishabhlingam", external: true },
  { label: "Twitter", href: "https://twitter.com/rishabhlingam", external: true },
  { label: "Email", href: "mailto:hello@rishabhlingam.com", external: true },
];
...
export default function Contact({ email, github, linkedin, twitter }: ContactProps) {
  ...
  const links = [
    { label: "GitHub", href: github || "https://github.com/rishabhlingam", external: true },
    { label: "LinkedIn", href: linkedin || "https://linkedin.com/in/rishabhlingam", external: true },
    { label: "Twitter", href: twitter || "https://twitter.com/rishabhlingam", external: true },
    { label: "Email", href: `mailto:${email || "hello@rishabhlingam.com"}`, external: true },
  ];
  void socialLinks; // suppress unused warning

  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setStatus("sending");
    // Integrate with your preferred form service (e.g., Resend, Formspree)
  ...
  return (
    <Section id="contact">
      <div className="max-w-5xl mx-auto px-10 md:px-20">
        <div className="mb-12">
          <p className="text-xs text-white/30 tracking-[0.4em] uppercase mb-3">08</p>
          ...
          <div>
            {status === "sent" ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label className="block text-xs text-white/30 tracking-wider uppercase mb-2">
                    Name
                  </label>
                  <input
                    type="text"
