...
function HexLogo() {
  return (
    <Link href="/" aria-label="Home">
      {/*
        motion.div as the hover target — propagates "hover" variant to all
        children so the bloom, hex rotation, and text glow all respond together.
        Everything is inline / Framer Motion so no CSS class can be dropped by
        the build pipeline.
      */}
      <motion.div
        ...
        animate="rest"
      >
        {/* White aurora bloom — purely Framer Motion, no CSS class needed */}
        <motion.div
        ...
        <motion.span
          ...
          variants={{
            rest:  { textShadow: "0 0 8px rgba(255,255,255,0.55), 0 0 20px rgba(255,255,255,0.20)" },
            hover: { textShadow: "0 0 8px rgba(255,255,255,0.95), 0 0 24px rgba(255,255,255,0.55)" },
          }}
          transition={{ duration: 0.4 }}
        >
          RL
